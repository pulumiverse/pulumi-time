...
public final class SleepState extends com.pulumi.resources.ResourceArgs {

    public static final SleepState Empty = new SleepState();
    ...
    public static Builder builder(SleepState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SleepState defaults) {
            $ = new SleepState(Objects.requireNonNull(defaults));
        }
