...
`terraform-provider-time`.  Substitute
...
1. **Add provider configuration overrides (not typically needed):** Pulumi's
   ...
   `time_API_KEY`.  Examples of common
   uses cases:
...
1. Copy the `pulumi-resource-time` binary
