...
replace github.com/hashicorp/terraform-provider-time/shim => ./shim
...
require (
	...
	github.com/hashicorp/terraform-provider-time v0.9.2-0.20231009125629-369f6289b49b // indirect
